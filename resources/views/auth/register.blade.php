                ...
                <div class="mt-10 w-full max-w-md">
                    <div class="rounded-2xl border border-white/60 bg-white/80 p-8 shadow-xl shadow-slate-200/70 backdrop-blur">
                        <div class="text-center">
                            <h2 class="text-xl font-semibold text-[#6f62f7]">Create Account</h2>
                            <p class="mt-1 text-sm text-slate-500">Join to manage and track school events</p>
                        </div>

                        <div class="mt-6 rounded-full bg-slate-100 p-1">
                            <div class="grid grid-cols-2 text-center text-sm font-medium">
                                <a class="rounded-full px-3 py-2 text-slate-500 transition hover:text-slate-800" href="{{ route('login') }}">Login</a>
                                <span class="rounded-full bg-white px-3 py-2 text-slate-800 shadow">Sign Up</span>
                            </div>
                        </div>
